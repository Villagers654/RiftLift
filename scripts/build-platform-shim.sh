...
overrides='^(ovr_PlatformInitializeUnrealWindows|ovr_PlatformInitializeWindows|ovr_IsPlatformInitialized|ovr_IsEntitled|ovr_GetLoggedInUserID|ovr_User_GetLoggedInUser|ovr_User_GetAccessToken|ovr_User_GetOrgScopedID|ovr_User_GetUserProof|ovr_Entitlement_GetIsViewerEntitled|ovr_Achievements_GetAllDefinitions|ovr_Achievements_GetAllProgress|ovr_CloudStorage_LoadBucketMetadata|ovr_CloudStorage_Load|ovr_User_GetLoggedInUserFriends|ovr_PopMessage|ovr_Message_GetRequestID|ovr_Message_GetType|ovr_Message_IsError|ovr_Message_GetUser|ovr_Message_GetString|ovr_Message_GetOrgScopedID|ovr_OrgScopedID_GetID|ovr_Message_GetUserProof|ovr_UserProof_GetNonce|ovr_Message_GetAchievementDefinitionArray|ovr_AchievementDefinitionArray_GetSize|ovr_AchievementDefinitionArray_HasNextPage|ovr_Message_GetAchievementProgressArray|ovr_AchievementProgressArray_GetSize|ovr_AchievementProgressArray_HasNextPage|ovr_Message_GetCloudStorageMetadataArray|ovr_CloudStorageMetadataArray_GetSize|ovr_CloudStorageMetadataArray_HasNextPage|ovr_Message_GetUserArray|ovr_UserArray_GetSize|ovr_UserArray_HasNextPage|ovr_User_GetID|ovr_User_GetOculusID|ovr_FreeMessage)$'
